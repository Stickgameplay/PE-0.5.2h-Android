...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['seu merda', 0.2], //From 0% to 19%
		['+ ou -', 0.4], //From 20% to 39%
		['ok', 0.5], //From 40% to 49%
		['td bem', 0.6], //From 50% to 59%
		['isso e bom', 0.69], //From 60% to 68%
		['incrivel', 0.7], //69%
		['vc e top!', 0.8], //From 70% to 79%
		['uau legal!', 0.9], //From 80% to 89%
		['Vc e uma lenda', 1], //From 90% to 99%
		['impossivel!!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
